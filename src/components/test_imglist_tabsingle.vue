<template>
  <div class="main">
    <div class="left">
      ...
      <el-row>
        <el-button type="primary" @click="changeImage('image')">原图</el-button>
      ...
      <el-card class="box-card">
        <el-carousel :interval="5000" arrow="always" v-if="imgSrC" trigger="click" height="800px" :autoplay=false>
          <el-carousel-item v-for="(item,index) in imgSrC" :key="index">
            <el-image :src="item" alt="" :preview-src-list="[item]" fit="contain"></el-image>
          </el-carousel-item>
        </el-carousel>
      </el-card>
    </div>
